...
const TXTEmbedding = ({ loading, setLoading, setOpen, setMessage, setStatus }) => {
    ...
    const handleSubmit = async (evt) => {
        ...
        const res = await fetch(process.env.REACT_APP_BASE_URL + "/api/langchain/txt_embedding", {
            method: "POST",
            body: data,
        });
        setLoading(false);
